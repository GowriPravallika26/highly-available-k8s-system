...
```bash
kubectl get pods -n highly-available-k8s-system
kubectl get svc -n highly-available-k8s-system
```
## 6.To open the web
```bash
  minikube service web-service -n highly-available-k8s-system
```
---
...
```bash
kubectl get cronjob -n highly-available-k8s-system
```
...
```bash
kubectl delete pod web-app-<pod-name> -n highly-available-k8s-system
kubectl get pods -n highly-available-k8s-system
```
